...
public interface Device {
	 ...
	 * @return returns java.util.List<org.onvif.ver10.device.wsdl.Service>
	 */
	...
	public List<Service> getServices(
			@WebParam(name = "IncludeCapability", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") boolean includeCapability);

	/**
	 * Returns the capabilities of the device service. The result is returned in
	 * a typed answer.
	 * 
	 * @return returns org.onvif.ver10.device.wsdl.DeviceServiceCapabilities
	 */
	...
	public void getDeviceInformation(
			@WebParam(name = "Manufacturer", targetNamespace = "http://www.onvif.org/ver10/device/wsdl", mode = WebParam.Mode.OUT) Holder<String> manufacturer,
			@WebParam(name = "Model", targetNamespace = "http://www.onvif.org/ver10/device/wsdl", mode = WebParam.Mode.OUT) Holder<String> model,
			@WebParam(name = "FirmwareVersion", targetNamespace = "http://www.onvif.org/ver10/device/wsdl", mode = WebParam.Mode.OUT) Holder<String> firmwareVersion,
			@WebParam(name = "SerialNumber", targetNamespace = "http://www.onvif.org/ver10/device/wsdl", mode = WebParam.Mode.OUT) Holder<String> serialNumber,
			@WebParam(name = "HardwareId", targetNamespace = "http://www.onvif.org/ver10/device/wsdl", mode = WebParam.Mode.OUT) Holder<String> hardwareId);
	...
	public void setSystemDateAndTime(
			@WebParam(name = "DateTimeType", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") SetDateTimeType dateTimeType,
			@WebParam(name = "DaylightSavings", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") boolean daylightSavings,
			@WebParam(name = "TimeZone", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") TimeZone timeZone,
			@WebParam(name = "UTCDateTime", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") DateTime utcDateTime);

	/**
	 * 
	 * @return returns org.onvif.ver10.schema.SystemDateTime
	 */
	...
	public void setSystemFactoryDefault(
			@WebParam(name = "FactoryDefault", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") FactoryDefaultType factoryDefault);

	/**
	 * This operation upgrades a device firmware version. After a successful
	 * upgrade the response message is sent before the device reboots. The
	 * device should support firmware upgrade through the UpgradeSystemFirmware
	 * command. The exact format of the firmware data is outside the scope of
	 * this standard.
	 * 
	 * @param firmware
	...
	public String upgradeSystemFirmware(
			@WebParam(name = "Firmware", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") AttachmentData firmware);
	 ...
	 * previously retrieved from a device. The device should support restore of
	 * backup configuration file(s) through the RestoreSystem command. The exact
	 * format of the backup configuration file(s) is outside the scope of this
	 * standard. If the command is supported, it shall accept backup files
	 * returned by the GetSystemBackup command.
	 * 
	 * @param backupFiles
	 */
	...
	public void restoreSystem(
			@WebParam(name = "BackupFiles", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<BackupFile> backupFiles);

	/**
	 * This operation is retrieves system backup configuration file(s) from a
	 * device. The device should support return of back up configuration file(s)
	 * through the GetSystemBackup command. The backup is returned with
	 * reference to a name and mime-type together with binary data. The exact
	 * format of the backup configuration files is outside the scope of this
	 * standard.
	 * 
	 * @return returns java.util.List<org.onvif.ver10.schema.BackupFile>
	 */
	 ...
	 * 
	 * @param logType
	 * @return returns org.onvif.ver10.schema.SystemLog
	 */
	...
	public SystemLog getSystemLog(
			@WebParam(name = "LogType", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") SystemLogType logType);

	/**
	 * This operation gets arbitary device diagnostics information from the
	 * device.
	 * 
	 * @return returns org.onvif.ver10.schema.SupportInformation
	 */
	...
	/**
	 * 
	 * @return returns java.util.List<org.onvif.ver10.schema.Scope>
	 */
	...
	/**
	 * This operation sets the scope parameters of a device. The scope
	 * parameters are used in the device discovery to match a probe message.
	 * This operation replaces all existing configurable scope parameters (not
	 * fixed parameters). If this shall be avoided, one should use the scope add
	 * command instead. The device shall support configuration of discovery
	...
	public void setScopes(
			@WebParam(name = "Scopes", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<String> scopes);

	/**
	 * This operation adds new configurable scope parameters to a device. The
	 * scope parameters are used in the device discovery to match a probe
	 * message. The device shall support addition of discovery scope parameters
	 * through the AddScopes command.
	 * 
	 * @param scopeItem
	 */
	...
	public void addScopes(
			@WebParam(name = "ScopeItem", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<String> scopeItem);

	/**
	 * This operation deletes scope-configurable scope parameters from a device.
	 * The scope parameters are used in the device discovery to match a probe
	 * message, see Section 7. The device shall support deletion of discovery
	 * scope parameters through the RemoveScopes command. Table
	 * 
	 * @param scopeItem
	 */
	...
	public void removeScopes(
			@WebParam(name = "ScopeItem", targetNamespace = "http://www.onvif.org/ver10/device/wsdl", mode = WebParam.Mode.INOUT) Holder<List<String>> scopeItem);
	 ...
	 * 
	 * @return returns org.onvif.ver10.schema.DiscoveryMode
	 */
	 ...
	 * 7.2 for the definition of the different device discovery modes. The
	 * device shall support configuration of the discovery mode setting through
	...
	public void setDiscoveryMode(
			@WebParam(name = "DiscoveryMode", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") DiscoveryMode discoveryMode);

	/**
	 * This operation gets the remote discovery mode of a device. See Section
	 * 7.4 for the definition of remote discovery extensions. A device that
	 * supports remote discovery shall support retrieval of the remote discovery
	 * mode setting through the GetRemoteDiscoveryMode command.
	 * 
	 * @return returns org.onvif.ver10.schema.DiscoveryMode
	 */
	 ...
	 * See Section 7.4 for the definition of remote discovery remote extensions.
	 * A device that supports remote discovery shall support configuration of
	 * the discovery mode setting through the SetRemoteDiscoveryMode command.
	 * 
	...
	public void setRemoteDiscoveryMode(
			@WebParam(name = "RemoteDiscoveryMode", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") DiscoveryMode remoteDiscoveryMode);

	/**
	 * This operation gets the remote DP address or addresses from a device. If
	 * the device supports remote discovery, as specified in Section 7.4, the
	 * device shall support retrieval of the remote DP address(es) through the
	 * GetDPAddresses command.
	 * 
	 * @return returns java.util.List<org.onvif.ver10.schema.NetworkHost>
	 */
	 ...
	 * 
	 * @param parameters
	 * @return returns org.onvif.ver10.device.wsdl.GetEndpointReferenceResponse
	 */
	...
	public GetEndpointReferenceResponse getEndpointReference(
			@WebParam(name = "GetEndpointReference", targetNamespace = "http://www.onvif.org/ver10/device/wsdl", partName = "parameters") GetEndpointReference parameters);

	/**
	 * 
	 * @return returns org.onvif.ver10.schema.RemoteUser
	 */
	...
	public void setRemoteUser(
			@WebParam(name = "RemoteUser", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") RemoteUser remoteUser);

	/**
	 * This operation lists the registered users and corresponding credentials
	 * on a device. The device shall support retrieval of registered device
	 * users and their credentials for the user token through the GetUsers
	 * command.
	 * 
	 * @return returns java.util.List<org.onvif.ver10.schema.User>
	 */
	...
	public void createUsers(
			@WebParam(name = "User", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<User> user);

	/**
	 * This operation deletes users on a device. The device shall support
	 * deletion of device users and their credentials through the DeleteUsers
	 * command. A device may have one or more fixed users that cannot be deleted
	 * to ensure access to the unit. Either all users are deleted successfully
	 * or a fault message shall be returned and no users be deleted.
	 * 
	 * @param username
	 */
	...
	public void deleteUsers(
			@WebParam(name = "Username", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<String> username);

	/**
	 * This operation updates the settings for one or several users on a device
	 * for authentication purposes. The device shall support update of device
	 * users and their credentials through the SetUser command. Either all
	 * change requests are processed successfully or a fault message shall be
	 * returned and no change requests be processed.
	 * 
	 * @param user
	 */
	 ...
	 * retrieve the complete schema and WSDL definitions of a device. The
	 * command gives in return a URL entry point where all the necessary product
	 * specific WSDL and schema definitions can be retrieved. The device shall
	 * provide a URL for WSDL and schema download through the GetWsdlUrl
	 * command.
	 * 
	 * @return returns java.lang.String
	 */
	...
	/**
	 * Any endpoint can ask for the capabilities of a device using the
	 * capability exchange request response operation. The device shall indicate
	 * all its ONVIF compliant capabilities through the GetCapabilities command.
	 * The capability list includes references to the addresses (XAddr) of the
	 * service implementing the interface operations in the category. Apart from
	 * the addresses, the capabilities only reflect optional functions.
	 * 
	 * @param category
	 * @return returns org.onvif.ver10.schema.Capabilities
	 */
	...
	public Capabilities getCapabilities(
			@WebParam(name = "Category", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<CapabilityCategory> category);

	/**
	 * This operation sets the remote DP address or addresses on a device. If
	 * the device supports remote discovery, as specified in Section 7.4, the
	 * device shall support configuration of the remote DP address(es) through
	 * the SetDPAddresses command.
	 * 
	 * @param dpAddress
	 */
	...
	public void setDPAddresses(
			@WebParam(name = "DPAddress", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<NetworkHost> dpAddress);
	 ...
	 * GetHostname command.
	 * 
	 * @return returns org.onvif.ver10.schema.HostnameInformation
	 */
	...
	public void setHostname(
			@WebParam(name = "Name", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") String name);
	...
	public boolean setHostnameFromDHCP(
			@WebParam(name = "FromDHCP", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") boolean fromDHCP);
	 ...
	 * 
	 * @return returns org.onvif.ver10.schema.DNSInformation
	 */
	 ...
	 * set the device DNS configurations through the SetDNS command.
	 * 
	 * @param searchDomain
	 * @param fromDHCP
	 * @param dnsManual
	...
	public void setDNS(
			@WebParam(name = "FromDHCP", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") boolean fromDHCP,
			@WebParam(name = "SearchDomain", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<String> searchDomain,
			@WebParam(name = "DNSManual", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<IPAddress> dnsManual);

	/**
	 * This operation gets the NTP settings from a device. If the device
	 * supports NTP, it shall be possible to get the NTP server settings through
	 * the GetNTP command.
	 * 
	 * @return returns org.onvif.ver10.schema.NTPInformation
	 */
	...
	public void setNTP(
			@WebParam(name = "FromDHCP", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") boolean fromDHCP,
			@WebParam(name = "NTPManual", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<NetworkHost> ntpManual);
	 ...
	 * command.
	 * 
	 * @return returns org.onvif.ver10.schema.DynamicDNSInformation
	 */
	 ...
	 * supports dynamic DNS as specified in [RFC 2136] and [RFC 4702], it shall
	 * be possible to set the type, name and TTL through the SetDynamicDNS
	 * command.
	 * 
	 * @param name
	 * @param ttl
	...
	public void setDynamicDNS(
			@WebParam(name = "Type", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") DynamicDNSType type,
			@WebParam(name = "Name", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") String name,
			@WebParam(name = "TTL", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") Duration ttl);

	/**
	 * This operation gets the network interface configuration from a device.
	 * The device shall support return of network interface configuration
	 * settings as defined by the NetworkInterface type through the
	 * GetNetworkInterfaces command.
	 * 
	 * @return returns java.util.List<org.onvif.ver10.schema.NetworkInterface>
	 */
	...
	public boolean setNetworkInterfaces(
			@WebParam(name = "InterfaceToken", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") String interfaceToken,
			@WebParam(name = "NetworkInterface", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") NetworkInterfaceSetConfiguration networkInterface);
	 ...
	 * network protocols.
	 * 
	 * @return returns java.util.List<org.onvif.ver10.schema.NetworkProtocol>
	 */
	 ...
	 * device shall support configuration of defined network protocols through
	...
	public void setNetworkProtocols(
			@WebParam(name = "NetworkProtocols", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<NetworkProtocol> networkProtocols);

	/**
	 * This operation gets the default gateway settings from a device. The
	 * device shall support the GetNetworkDefaultGateway command returning
	 * configured default gateway address(es).
	 * 
	 * @return returns org.onvif.ver10.schema.NetworkGateway
	 */
	 ...
	 * shall support configuration of default gateway through the
	...
	public void setNetworkDefaultGateway(
			@WebParam(name = "IPv4Address", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<String> iPv4Address,
			@WebParam(name = "IPv6Address", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<String> iPv6Address);

	/**
	 * 
	 * @return returns org.onvif.ver10.schema.NetworkZeroConfiguration
	 */
	...
	public void setZeroConfiguration(
			@WebParam(name = "InterfaceToken", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") String interfaceToken,
			@WebParam(name = "Enabled", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") boolean enabled);
	 ...
	 * 
	 * @return returns org.onvif.ver10.schema.IPAddressFilter
	 */
	 ...
	 * device supports device access control based on IP filtering rules (denied
	 * or accepted ranges of IP addresses), the device shall support
	 * configuration of IP filtering rules through the SetIPAddressFilter
	 * command.
	 * 
	...
	public void setIPAddressFilter(
			@WebParam(name = "IPAddressFilter", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") IPAddressFilter ipAddressFilter);

	/**
	 * This operation adds an IP filter address to a device. If the device
	 * supports device access control based on IP filtering rules (denied or
	 * accepted ranges of IP addresses), the device shall support adding of IP
	 ...
	 * supports device access control based on IP filtering rules (denied or
	 * accepted ranges of IP addresses), the device shall support deletion of IP
	 ...
	 * end-point authentication. Authorization decisions can then be taken using
	 * an access security policy. This standard does not mandate any particular
	 * policy description format or security policy but this is up to the device
	 * manufacturer or system provider to choose policy and policy description
	 * format of choice. However, an access policy (in arbitrary format) can be
	 * requested using this command. If the device supports access policy
	 * settings based on WS-Security authentication, then the device shall
	 * support this command.
	 * 
	 * @return returns org.onvif.ver10.schema.BinaryData
	 */
	 ...
	 * the access security policy see the Get command). If the device supports
	 * access policy settings based on WS-Security authentication, then the
	 * device shall support this command.
	 * 
	 * @param policyFile
	 */
	...
	public void setAccessPolicy(
			@WebParam(name = "PolicyFile", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") BinaryData policyFile);
	 ...
	 * @return returns org.onvif.ver10.schema.Certificate
	 */
	...
	public Certificate createCertificate(
			@WebParam(name = "CertificateID", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") String certificateID,
			@WebParam(name = "Subject", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") String subject,
			@WebParam(name = "ValidNotBefore", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") XMLGregorianCalendar validNotBefore,
			@WebParam(name = "ValidNotAfter", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") XMLGregorianCalendar validNotAfter);

	/**
	 * This operation gets all device server certificates (including
	 * self-signed) for the purpose of TLS authentication and all device client
	 * certificates for the purpose of IEEE 802.1X authentication. This command
	 * lists only the TLS server certificates and IEEE 802.1X client
	 * certificates for the device (neither trusted CA certificates nor trusted
	 * root certificates). The certificates are returned as binary data. A
	 * device that supports TLS shall support this command and the certificates
	 * shall be encoded using ASN.1 [X.681], [X.682], [X.683] DER [X.690]
	 * encoding rules.
	 * 
	 * @return returns java.util.List<org.onvif.ver10.schema.Certificate>
	 */
	 ...
	 * status (enabled/disabled) of the device TLS server certificates. A device
	 * that supports TLS shall support this command.
	 * 
	 * @return returns java.util.List<org.onvif.ver10.schema.CertificateStatus>
	 */
	 ...
	 * status (enable/disable) of the device TLS server certificates. A device
	 * that supports TLS shall support this command. Typically only one device
	 * server certificate is allowed to be enabled at a time.
	 * 
	...
	public void setCertificatesStatus(
			@WebParam(name = "CertificateStatus", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<CertificateStatus> certificateStatus);

	/**
	 * This operation deletes a certificate or multiple certificates. The device
	 * MAY also delete a private/public key pair which is coupled with the
	 * certificate to be deleted. The device that support either TLS or IEEE
	 * 802.1X shall support the deletion of a certificate or multiple
	 * certificates through this command. Either all certificates are deleted
	 * successfully or a fault message shall be returned without deleting any
	 * certificate.
	 * 
	 * @param certificateID
	 */
	...
	public void deleteCertificates(
			@WebParam(name = "CertificateID", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<String> certificateID);
	...
	public BinaryData getPkcs10Request(
			@WebParam(name = "CertificateID", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") String certificateID,
			@WebParam(name = "Subject", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") String subject,
			@WebParam(name = "Attributes", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") BinaryData attributes);
	...
	public void loadCertificates(
			@WebParam(name = "NVTCertificate", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<Certificate> nvtCertificate);

	/**
	 * This operation is specific to TLS functionality. This operation gets the
	 * status (enabled/disabled) of the device TLS client authentication. A
	 * device that supports TLS shall support this command.
	 * 
	 * @return returns boolean
	 */
	...
	/**
	 * 
	 * @return returns java.util.List<org.onvif.ver10.schema.RelayOutput>
	 */
	...
	public void setRelayOutputSettings(
			@WebParam(name = "RelayOutputToken", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") String relayOutputToken,
			@WebParam(name = "Properties", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") RelayOutputSettings properties);
	...
	public void setRelayOutputState(
			@WebParam(name = "RelayOutputToken", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") String relayOutputToken,
			@WebParam(name = "LogicalState", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") RelayLogicalState logicalState);
	...
	public String sendAuxiliaryCommand(
			@WebParam(name = "AuxiliaryCommand", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") String auxiliaryCommand);

	/**
	 * CA certificates will be loaded into a device and be used for the sake of
	 * following two cases. The one is for the purpose of TLS client
	 * authentication in TLS server function. The other one is for the purpose
	 * of Authentication Server authentication in IEEE 802.1X function. This
	 * operation gets all CA certificates loaded into a device. A device that
	 * supports either TLS client authentication or IEEE 802.1X shall support
	 * this command and the returned certificates shall be encoded using ASN.1
	 * [X.681], [X.682], [X.683] DER [X.690] encoding rules.
	 * 
	 * @return returns java.util.List<org.onvif.ver10.schema.Certificate>
	 */
	...
	public void loadCertificateWithPrivateKey(
			@WebParam(name = "CertificateWithPrivateKey", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<CertificateWithPrivateKey> certificateWithPrivateKey);

	/**
	 * 
	 * @param certificateID
	 * @return returns org.onvif.ver10.schema.CertificateInformation
	 */
	...
	public void loadCACertificates(
			@WebParam(name = "CACertificate", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<Certificate> caCertificate);

	/**
	 * This operation newly creates IEEE 802.1X configuration parameter set of
	 * the device. The device shall support this command if it supports IEEE
	 * 802.1X. If the device receives this request with already existing
	 * configuration token (Dot1XConfigurationToken) specification, the device
	 * should respond with 'ter:ReferenceToken ' error to indicate there is some
	...
	public void createDot1XConfiguration(
			@WebParam(name = "Dot1XConfiguration", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") Dot1XConfiguration dot1XConfiguration);

	/**
	 * While the CreateDot1XConfiguration command is trying to create a new
	 * configuration parameter set, this operation modifies existing IEEE 802.1X
	 * configuration parameter set of the device. A device that support IEEE
	 * 802.1X shall support this command.
	 * 
	 * @param dot1XConfiguration
	 */
	 ...
	 * @return returns org.onvif.ver10.schema.Dot1XConfiguration
	 */
	...
	public Dot1XConfiguration getDot1XConfiguration(
			@WebParam(name = "Dot1XConfigurationToken", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") String dot1XConfigurationToken);

	/**
	 * 
	 * @return returns java.util.List<org.onvif.ver10.schema.Dot1XConfiguration>
	 */
	...
	/**
	 * This operation deletes an IEEE 802.1X configuration parameter set from
	 * the device. Which configuration should be deleted is specified by the
	 * 'Dot1XConfigurationToken' in the request. A device that support IEEE
	 * 802.1X shall support this command.
	 * 
	 * @param dot1XConfigurationToken
	 */
	...
	public void deleteDot1XConfiguration(
			@WebParam(name = "Dot1XConfigurationToken", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") List<String> dot1XConfigurationToken);
	 ...
	 * 
	 * @param parameters
	 * @return returns org.onvif.ver10.device.wsdl.GetDot11CapabilitiesResponse
	 */
	...
	public GetDot11CapabilitiesResponse getDot11Capabilities(
			@WebParam(name = "GetDot11Capabilities", targetNamespace = "http://www.onvif.org/ver10/device/wsdl", partName = "parameters") GetDot11Capabilities parameters);
	 ...
	 * 
	 * @param interfaceToken
	 * @return returns org.onvif.ver10.schema.Dot11Status
	 */
	 ...
	 * device. A device should support this operation.
	 * 
	 * @param interfaceToken
	 * @return returns
	 *         java.util.List<org.onvif.ver10.schema.Dot11AvailableNetworks>
	 */
	...
	public void getSystemUris(
			@WebParam(name = "SystemLogUris", targetNamespace = "http://www.onvif.org/ver10/device/wsdl", mode = WebParam.Mode.OUT) Holder<SystemLogUriList> systemLogUris,
			@WebParam(name = "SupportInfoUri", targetNamespace = "http://www.onvif.org/ver10/device/wsdl", mode = WebParam.Mode.OUT) Holder<String> supportInfoUri,
			@WebParam(name = "SystemBackupUri", targetNamespace = "http://www.onvif.org/ver10/device/wsdl", mode = WebParam.Mode.OUT) Holder<String> systemBackupUri,
			@WebParam(name = "Extension", targetNamespace = "http://www.onvif.org/ver10/device/wsdl", mode = WebParam.Mode.OUT) Holder<org.onvif.ver10.device.wsdl.GetSystemUrisResponse.Extension> extension);
	...
	public void startFirmwareUpgrade(
			@WebParam(name = "UploadUri", targetNamespace = "http://www.onvif.org/ver10/device/wsdl", mode = WebParam.Mode.OUT) Holder<String> uploadUri,
			@WebParam(name = "UploadDelay", targetNamespace = "http://www.onvif.org/ver10/device/wsdl", mode = WebParam.Mode.OUT) Holder<Duration> uploadDelay,
			@WebParam(name = "ExpectedDownTime", targetNamespace = "http://www.onvif.org/ver10/device/wsdl", mode = WebParam.Mode.OUT) Holder<Duration> expectedDownTime);
	 ...
	 * 
	 * @return returns
	 *         java.util.List<org.onvif.ver10.device.wsdl.StorageConfiguration>
	 */
	...
	/**
	 * This operation creates a new storage configuration. The configuration
	 * data shall be created in the device and shall be persistent (remain after
	 * reboot).
	 * 
	...
	public String createStorageConfiguration(
			@WebParam(name = "StorageConfiguration", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") StorageConfigurationData storageConfiguration);
	 ...
	 * 
	 * @param token
	 * @return returns org.onvif.ver10.device.wsdl.StorageConfiguration
	 */
	...
	public StorageConfiguration getStorageConfiguration(
			@WebParam(name = "Token", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") String token);
	...
	public void setStorageConfiguration(
			@WebParam(name = "StorageConfiguration", targetNamespace = "http://www.onvif.org/ver10/device/wsdl") StorageConfiguration storageConfiguration);
