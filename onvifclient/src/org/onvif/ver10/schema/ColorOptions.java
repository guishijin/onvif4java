 ...
 * the range of color value. The following values are acceptable for Colourspace
 * attribute.
 * 
 * <pre>
 ...
 * 
 * <p>
 * Java class for ColorOptions complex type.
 * 
 * <p>
...
public class ColorOptions {
	 ...
	 * <CODE>set</CODE> method for the colorList property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the colorspaceRange property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
