 ...
 * element interface generated in the org.oasis_open.docs.wsrf.bf_2 package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _BaseFault_QNAME = new QName(
			"http://docs.oasis-open.org/wsrf/bf-2", "BaseFault");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: org.oasis_open.docs.wsrf.bf_2
	 * 
	 */
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link BaseFaultType }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<BaseFaultType> createBaseFault(BaseFaultType value) {
		return new JAXBElement<BaseFaultType>(_BaseFault_QNAME,
				BaseFaultType.class, null, value);
	}
