 ...
 * 
 * <p>
 * Java class for SearchScope complex type.
 * 
 * <p>
...
@XmlType(name = "SearchScope", propOrder = { "includedSources",
		"includedRecordings", "recordingInformationFilter", "extension" })
public class SearchScope {
	 ...
	 * <CODE>set</CODE> method for the includedSources property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the includedRecordings property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
