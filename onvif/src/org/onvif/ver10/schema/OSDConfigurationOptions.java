...
/**
 * <p>
 * Java class for OSDConfigurationOptions complex type.
 * 
 * <p>
...
@XmlType(name = "OSDConfigurationOptions", propOrder = { "maximumNumberOfOSDs",
		"type", "positionOption", "textOption", "imageOption", "extension" })
public class OSDConfigurationOptions {
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the positionOption property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
