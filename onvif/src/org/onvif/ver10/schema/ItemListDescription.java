 ...
 * 
 * <p>
 * Java class for ItemListDescription complex type.
 * 
 * <p>
...
@XmlType(name = "ItemListDescription", propOrder = { "simpleItemDescription",
		"elementItemDescription", "extension" })
public class ItemListDescription {
	 ...
	 * <CODE>set</CODE> method for the simpleItemDescription property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the elementItemDescription property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
