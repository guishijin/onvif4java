...
/**
 * <p>
 * Java class for SupportedAnalyticsModules complex type.
 * 
 * <p>
...
@XmlType(name = "SupportedAnalyticsModules", propOrder = {
		"analyticsModuleContentSchemaLocation", "analyticsModuleDescription",
		"extension" })
public class SupportedAnalyticsModules {
	 ...
	 * <CODE>set</CODE> method for the analyticsModuleContentSchemaLocation
	 * property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the analyticsModuleDescription property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
