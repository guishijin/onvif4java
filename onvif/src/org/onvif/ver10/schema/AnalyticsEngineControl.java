...
/**
 * <p>
 * Java class for AnalyticsEngineControl complex type.
 * 
 * <p>
...
@XmlType(name = "AnalyticsEngineControl", propOrder = { "engineToken",
		"engineConfigToken", "inputToken", "receiverToken", "multicast",
...
public class AnalyticsEngineControl extends ConfigurationEntity {
	 ...
	 * <CODE>set</CODE> method for the inputToken property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the receiverToken property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
