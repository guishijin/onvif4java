...
/**
 * <p>
 * Java class for SupportedRules complex type.
 * 
 * <p>
...
@XmlType(name = "SupportedRules", propOrder = { "ruleContentSchemaLocation",
...
public class SupportedRules {
	 ...
	 * <CODE>set</CODE> method for the ruleContentSchemaLocation property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the ruleDescription property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
