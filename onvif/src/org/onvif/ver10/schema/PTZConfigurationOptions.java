...
/**
 * <p>
 * Java class for PTZConfigurationOptions complex type.
 * 
 * <p>
...
@XmlType(name = "PTZConfigurationOptions", propOrder = { "spaces",
		"ptzTimeout", "any", "ptControlDirection", "extension" })
public class PTZConfigurationOptions {
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the ptzRamps property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
