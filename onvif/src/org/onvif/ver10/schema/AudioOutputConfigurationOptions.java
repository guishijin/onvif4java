...
/**
 * <p>
 * Java class for AudioOutputConfigurationOptions complex type.
 * 
 * <p>
...
@XmlType(name = "AudioOutputConfigurationOptions", propOrder = {
		"outputTokensAvailable", "sendPrimacyOptions", "outputLevelRange",
		"any" })
public class AudioOutputConfigurationOptions {
	 ...
	 * <CODE>set</CODE> method for the outputTokensAvailable property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the sendPrimacyOptions property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
