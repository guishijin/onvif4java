 ...
 * element interface generated in the org.onvif.ver10.device.wsdl package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _Capabilities_QNAME = new QName(
			"http://www.onvif.org/ver10/device/wsdl", "Capabilities");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: org.onvif.ver10.device.wsdl
	 * 
	 */
	 ...
	 * {@link DeviceServiceCapabilities }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://www.onvif.org/ver10/device/wsdl", name = "Capabilities")
	public JAXBElement<DeviceServiceCapabilities> createCapabilities(
			DeviceServiceCapabilities value) {
		return new JAXBElement<DeviceServiceCapabilities>(_Capabilities_QNAME,
				DeviceServiceCapabilities.class, null, value);
	}
